 ...
 * создания, счётчики rate limit) периодически конфликтуют на уровне Postgres — это ожидаемое
 * поведение, а не баг, и клиент не должен получать 5xx на ровном месте.
 ...
 * это гарантирует вызывающий код (например, в создании уведомления advisory-lock и поиск
 * дедуп-якоря перед вставкой делают повтор эквивалентным первому вызову).
 *
