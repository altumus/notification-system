...
/**
 * DI-токен реестра присутствия (in-memory сейчас, Redis — в коммите 15).
 */
 ...
 *
 * Зачем: один инстанс API без Redis (коммит 12); в 15 заменится адаптером без смены потребителей.
